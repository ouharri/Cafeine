<?php
/**
 * Blossom Recipe Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Recipe_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Recipe_Repeater_Setting extends WP_Customize_Setting {
