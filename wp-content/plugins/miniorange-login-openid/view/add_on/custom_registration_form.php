                                ...
                                <tr>
                                    <td align="left" colspan="7">
                                        ...
                                        <ol>
                                            ...
                                            <li><?php echo esc_attr(mo_sl( 'Copy the page link and paste it in the above field <b>Registration page
                                                    link'));?></b>.
                                            </li>
                                            <li><?php echo esc_attr(mo_sl( "If you have any existing wp_usermeta field then enter that field's name in"));?>
                                                <b><?php echo esc_attr(mo_sl('Existing
                                                    Field'));?></b> <?php echo esc_attr(mo_sl('column. For example, if you are saving'));?> <b><?php echo esc_attr(mo_sl('First Name'));?></b> <?php echo esc_attr(mo_sl('as'));?>
                                                <b><?php echo esc_attr(mo_sl('fname'));?></b>
                                                <?php echo esc_attr(mo_sl('in wp_usermeta field then enter <b>fname</b> in <b>Existing Field</b>
                                                column.'));?>
                                            </li>
                                            ...
                                            <li> <?php echo esc_attr(mo_sl('If selected field is other than custom, then'));?> <b><?php echo esc_attr(mo_sl('Field Type'));?></b> <?php echo esc_attr(mo_sl('will
                                                automatically be'));?> <b><?php echo esc_attr(mo_sl('Textbox'));?></b> <?php echo esc_attr(mo_sl('and there is no need to enter'));?> <b><?php echo esc_attr(mo_sl('Custom
                                                    name'));?></b> <?php echo esc_attr(mo_sl('and'));?> <b><?php echo esc_attr(mo_sl('Field options'));?></b>.
                                            </li>
                                            ...
                                            <li> <?php echo esc_attr(mo_sl('Select'));?> <b><?php echo esc_attr(mo_sl('Field Type'));?></b>, <?php echo esc_attr(mo_sl('if selected'));?> <b><?php echo esc_attr(mo_sl('Field Type'));?></b> <?php echo esc_attr(mo_sl('is'));?>
                                                <b><?php echo esc_attr(mo_sl('Checkbox'));?></b><?php echo esc_attr(mo_sl( 'or'));?> <b><?php echo esc_attr(mo_sl('Dropdown'));?></b> <?php ('then enter the desire options in');?> <b><?php echo esc_attr(mo_sl('Field
                                                    Options'));?></b> <?php echo esc_attr(mo_sl('seprated by semicolon '));?><b>;</b>'<?php echo esc_attr(mo_sl( 'otherwise leave'));?> <b><?php echo esc_attr(mo_sl('Field
                                                    Options'));?></b> <?php echo esc_attr(mo_sl('blank.'));?>
                                            </li>
                                            <li> <?php echo esc_attr(mo_sl('Select'));?> <b><?php echo esc_attr(mo_sl('Required Field'));?></b> <?php echo esc_attr(mo_sl('as'));?> <b><?php echo esc_attr(mo_sl('Yes'));?></b> <?php echo esc_attr(mo_sl('if you want to make that field
                                                compulsory for user'));?>.
                                            </li>
