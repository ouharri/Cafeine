                    ...
                    foreach ($app_pos as $active_app)
                    {
                        if(get_option('mo_openid_'.$active_app.'_enable')){
                            ...
                            if($active_app=='google'){
                                ...
                                <a id="mo_white_login_button_preview_google" class="mo_btn mo_btn-block mo_openid_mo_btn-whitetheme  mo_btn-social mo_btn-custom-size "> <img class="fa" src="<?php echo esc_url(PLUGIN_URL.'/g.png')?>"><?php
                                ...
                                <div style="display: inline-block" id="mo_hover_div_google" class="mo_hover_div" onmouseover="mo_hover_on(this,'<?php echo esc_attr($default_color[$active_app])?>','<?php echo esc_attr($active_app); ?>')" onmouseout="mo_hover_off(this,'<?php echo esc_attr($default_color[$active_app])?>','<?php echo esc_attr($active_app); ?>')">
                                    ...
                                    <a id="mo_hover_login_button_preview_<?php echo esc_attr($active_app) ?>" class="mo_btn mo_btn-block mo_openid_mo_btn-hovertheme   mo_btn-social mo_btn-custom-size "> <i id="mo_hover_long_button_<?php echo esc_attr($active_app) ?>" style="color:<?php echo esc_attr($default_color[$active_app]);?>;" class="fab fa-<?php echo esc_attr($icon) ?> mofab"></i><?php
                                        echo esc_html(get_option('mo_openid_login_button_customize_text'));?> <?php echo esc_attr($active_app) ?></a>
                                </div>
                                ...
                                <a id="mo_login_button_preview_<?php echo esc_attr($active_app) ?>" class="mo_btn mo_btn-block mo_btn-defaulttheme mo_btn-social mo_btn-custom-size mo_login_button mo_btn-<?php echo esc_attr($icon) ?> <?php echo esc_attr($extra);?>"> <i class="fab fa-<?php echo esc_attr($icon) ?> mo_login_button mofab"></i><?php
                                    echo esc_html(get_option('mo_openid_login_button_customize_text'));?> <?php echo esc_attr($active_app)?></a>
                                ...
                                <a id="mo_white_login_button_preview_<?php echo esc_attr($active_app) ?>" class="mo_btn mo_btn-block mo_openid_mo_btn-whitetheme   mo_btn-social mo_btn-custom-size "> <i style="color:<?php echo esc_attr($default_color[$active_app]);?>;" class="fab fa-<?php echo esc_attr($icon) ?> mofab"></i><?php
                                    echo esc_html(get_option('mo_openid_login_button_customize_text'));?> <?php echo esc_attr($active_app) ?></a>
                                ...
                                <a id="mo_custom_login_button_preview_<?php echo esc_attr($active_app) ?>" class="mo_btn mo_btn-block mo_openid_mo_btn-customtheme mo_btn-social mo_btn-custom-size " style="color: #FFFFFF"> <i class="fab fa-<?php echo esc_attr($icon) ?> mofab"></i><?php
                                    echo esc_html(get_option('mo_openid_login_button_customize_text'));?> <?php echo esc_attr($active_app) ?></a>
                                <?php
                            }
                        }
