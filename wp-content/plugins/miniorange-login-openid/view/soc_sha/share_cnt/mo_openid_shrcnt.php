                        ...
                        <div class="mo_openid_sharecount " >
                            ...
                            <div style="font-size: 14px;">
                                ...
                                <ol>
                                    ...
                                    <li><?php echo esc_attr(mo_sl('Use an existing app if you already have one or create a new facebook
                                        app by clicking on '));?><b><?php echo esc_attr(mo_sl('Create App'));?></b>. <?php echo esc_attr(mo_sl('Go to'));?> <b><?php echo esc_attr(mo_sl('My Apps'));?></b> <?php echo esc_attr(mo_sl('and
                                        select'));?> <b><?php echo esc_attr(mo_sl('Create App'));?></b>.<?php echo esc_attr(mo_sl(' Enter Display Name i.e App Name and click
                                        on'));?> <b><?php echo esc_attr(mo_sl('Create App ID'));?></b>.
                                    </li>
                                    <li><?php echo esc_attr(mo_sl('Go to'));?> <b><?php echo esc_attr(mo_sl('Tools'));?></b><?php echo esc_attr(mo_sl( 'select'));?> <b><?php echo esc_attr(mo_sl('Graph API Explorer'));?></b> <?php echo esc_attr(mo_sl('and click on'));?> <b><?php echo esc_attr(mo_sl('Get
                                            Access Token'));?></b>.
                                    </li>
                                    ...
                                    <li><?php echo esc_attr(mo_sl('Now copy the'));?> <b><?php echo esc_attr(mo_sl('Access Token'));?></b> <?php echo esc_attr(mo_sl('and paste it in the above field and
                                        click on'));?> <b><?php echo esc_attr(mo_sl('save'));?></b>.
                                    </li>
                                </ol>
                                <p class="mo_openid_note_style"><span style="color: red">*</span><strong><?php echo esc_attr(mo_sl('According to the new updates of
