...
<div class="mo-openid-app-icons circle ">
	<p style="color: #<?php echo  esc_attr($heading_color); ?>;"><?php
		...
		if( $orientation == 'hor' ) {
	 	...
	 	?></p>
	 		<div class="horizontal">
                ...
                if( get_option('mo_openid_mail_share_enable') ) {
                    ?>
                    <a rel='nofollow' title="Email this page" onclick="popupCenter('mailto:?subject=<?php echo esc_attr($email_subject) ?>&amp;body=<?php echo esc_attr($email_body )
