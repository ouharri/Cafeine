<?php  
	...
	if($hs_abv_hdr=='1'):		
?>
	<div class="top-notification-bg top-notification-five above-header">
                        ...
                        <ul class="notification-entry">
							<?php if($hs_abv_hdr_info1=='1'): ?>	
								<li class="notify-wrap txt-wrap info1">
									<span class="call-label"><?php echo wp_kses_post($abv_hdr_info1); ?></span>
								</li>
							<?php endif; ?>	
							 <?php if($hs_abv_hdr_info2=='1'): ?>
								<li class="notify-wrap store-product">	
